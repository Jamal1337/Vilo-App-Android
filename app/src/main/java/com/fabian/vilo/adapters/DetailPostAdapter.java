...
public class DetailPostAdapter extends ArrayAdapter<Card> {

    private Card post;
    private Context context;
    private final int resourceID;

    public DetailPostAdapter(Context context, int textViewResourceId, List<Card> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(post != null) {
            ...
            viewHolder.quickMainText.setText(post.text);
